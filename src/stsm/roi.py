...
def start_roi(self, event):
    ...
    if x < img_x or x > img_x + img_width_scaled or y < img_y or y > img_y + img_height_scaled:
        return
    ...
    # Create a rectangle
    self.roi_rect = self.proc_canvas.create_rectangle(x, y, x, y, outline="red", width=2)
